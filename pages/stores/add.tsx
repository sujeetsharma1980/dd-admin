...
const AddData = () => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    const params = {
      ...
      Item: {
        pk: "STORES",
        sk: "S#" + event.target.storename.value.trim(), //uuidv4(),
    ...
    const getParams = {
      ...
      ExpressionAttributeValues: {
        ':prefix': 'STORES',
        ':meta': "S#" + event.target.storename.value.trim()
      }
    }
  ...
  return (
    <>
      <div className="container mx-auto py-10 flex flex-col w-screen items-center">
        ...
        <p className="text-3xl mb-20">Add Stores</p>
        <div className="block p-6 rounded-lg shadow-lg bg-white w-2/3 justify-self-center">
          <form onSubmit={handleSubmit} id="addData-form">
            <div className="form-group mb-6">
              <label htmlFor="storename" className="form-label inline-block mb-2 text-gray-700">Store Name</label>
              <input type="text" className={styles.inputField} id="storename" />
            </div>
            <div className="form-group mb-6">
