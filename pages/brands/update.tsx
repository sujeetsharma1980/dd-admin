...
const UpdateData = () => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    const params = {
      ...
      UpdateExpression:
        "set brandname = :p, lob = :r, image = :q, dateModified = :k, deleted = :o, showinnavigation = :t,showonhomepage = :s ",
  ...
  return (
    <>
      <div className="container mx-auto py-10 flex flex-col w-screen items-center">
        ...
        <p className="text-3xl mb-20">Update Brands</p>
        <div className="block p-6 rounded-lg shadow-lg bg-white w-2/3 justify-self-center">
          <form onSubmit={handleSubmit} id="addData-form">
            <div className="form-group mb-6">
              ...
              <input type="text" className={styles.inputField} id="brandname" name="brandname" defaultValue={data.brandname} />
            </div>
            <div className="form-group mb-6">
