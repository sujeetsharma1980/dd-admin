...
const ViewData = () => {
  ...
  return (
    ...
    <div className="container mx-auto py-10 flex flex-col w-screen h-screen items-center">
      ...
      <p className="text-3xl">View Brands</p>
              ...
              <table className="min-w-full">
                <thead className="border-b">
                  <tr>
                    ...
                    <th scope="col" className={Styles.tableHeadings}>Brand Name</th>
                ...
                <tbody>
                  {tableData.map((item: any) => (
                    <tr className="border-b" key={item.pk}>
                      ...
                      <td className={Styles.tableData}>{item.brandname}</td>
